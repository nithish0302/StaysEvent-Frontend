  ...
  return (
    <div className="page-wrapper py-10">
      <div className="container-main">
        {/* HEADER — FIX 4: was a fixed flex row, overflowed on mobile */}
        ...
        {/* EMPTY STATE — FIX 5: icon+heading were side by side at huge sizes,
            broke on mobile. Now stacked and responsively sized */}
